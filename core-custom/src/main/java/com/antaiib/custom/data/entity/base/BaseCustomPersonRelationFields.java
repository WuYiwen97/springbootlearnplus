...
public abstract class BaseCustomPersonRelationFields<M extends BaseCustomPersonRelationFields<M>> extends Model<M> implements IBean {
	...
	public void setRelatedFieldName(String relatedFieldName) {
		set("related_field_name", relatedFieldName);
	}
	...
	public String getRelatedFieldName() {
		return getStr("related_field_name");
	}

	/**
	 * 关联字段显示名
	 */
	public void setRelatedFieldLabel(String relatedFieldLabel) {
		set("related_field_label", relatedFieldLabel);
	}
	
	/**
	 * 关联字段显示名
	 */
	public String getRelatedFieldLabel() {
		return getStr("related_field_label");
	}
